...
const directions = [
  {
    ...
    benefitKeys: [
      "directions.microgreens_benefit1",
      "directions.microgreens_benefit2",
      "directions.microgreens_benefit3",
    ],
  ...
  },
  {
    ...
    benefitKeys: [
      "directions.supplements_benefit1",
      "directions.supplements_benefit2",
      "directions.supplements_benefit3",
    ],
  ...
  },
  {
    ...
    benefitKeys: [
      "directions.franchise_benefit1",
      "directions.franchise_benefit2",
      "directions.franchise_benefit3",
    ],
    href: "/franchise",
  },
  {
    ...
    benefitKeys: [
      "directions.education_benefit1",
      "directions.education_benefit2",
      "directions.education_benefit3",
    ],
    href: "/education",
  },
];
...
const testimonials = [
  {
    ...
    role: "Мижоз",
    content:
      "Organic Green маҳсулотлари ҳақиқатан ҳам сифатли. Микрозелень жуда тоза ва мазали!",
    rating: 5,
  ...
  },
  {
    ...
    role: "Франшиза эгаси",
    content:
      "Франшиза олгандан кейин даромадим 3 баробар ошди. Жуда мамнунман!",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Таълим курси жуда фойдали эди. Энди ўзим микрозелень етиштирамаан!",
    rating: 5,
            ...
            >
              ...
              >
                ...
                <Button
                  variant="outline"
                  size="xl"
                  className="group border-green-300 text-green-700 hover:bg-green-50"
                >
            ...
            >
              <Card className="p-8 border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                ...
                <blockquote className="text-lg text-gray-700 mb-6 italic">
                  &ldquo;{t(`testimonials.items.${currentTestimonial}.content`)}
                  &rdquo;
                </blockquote>
                ...
                <div className="flex items-center justify-center space-x-4">
                  <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                    <span className="text-green-600 font-semibold">
                      {t(
                        `testimonials.items.${currentTestimonial}.name`
                      ).charAt(0)}
                    </span>
                  </div>
                  <div>
        ...
        <div className="container">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-heading">
              ...
              <span className="text-gold">{t("certificates.highlight")}</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="xl"
                variant="gold"
                className="bg-gold hover:bg-yellow-600 text-white border-gold"
              >
                {t("cta.franchise")}
              </Button>
            </div>
